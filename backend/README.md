...
2. From the `backend` folder:
   ...
   mvn spring-boot:run
   ```
3. Open the backend on `https://veltroz-company-website.onrender.com`.
4. If you want to inspect the H2 database, open `https://veltroz-company-website.onrender.com/h2-console`.
